...
import com.paisa.expense_manager.databinding.FragmentStatsBinding;
import com.paisa.expense_manager.databinding.FragmentTransactionBinding;
...
//                updateDate();
        ...
        binding.tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(Objects.equals(Objects.requireNonNull(tab.getText()).toString(), "Monthly")){
                    Constants.SELECTED_STATS=1;
                    updateDate();
                }else if(Objects.requireNonNull(tab.getText()).toString().equals("Daily")){
